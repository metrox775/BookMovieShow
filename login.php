   ...
   <!--  <div class="imgcontainer">
    ...
    <div class="container">
      ...
      <center><div class="row">
       ...
       <div class="col-md-12">
        <button type="submit" name="loginclient" class="btn btn-primary"  style="background-color: #333;">Login</button><br><br>
        New Register? <a href="register.php" style="color:black">Register</a>
         <div>
      </div></center>
    </div>
